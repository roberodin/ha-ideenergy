...
API_USER_SESSION_TIMEOUT = 7200  # 2 hours - keeps is_logged=True so renew_session() is tried first


CONF_SCAN_INTERVAL = "scan_interval"
CONF_HIGH_POWER_THRESHOLD = "high_power_threshold"
DEFAULT_SCAN_INTERVAL = 5  # minutes
DEFAULT_HIGH_POWER_THRESHOLD = 3000  # watts
